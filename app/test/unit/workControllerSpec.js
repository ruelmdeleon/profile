describe('work experience controller', function() {

    describe('WorkIndexController', function(){
        ...
        beforeEach(inject(function(_$httpBackend_, $rootScope, $controller) {
            ...
            $httpBackend.expectGET('data/work_history.json').
                respond([{
                    "id": "broadvision",
                    ...
                    "id": "arizonahospitalandhealthcareassociation",
                    "startDate": "June 2007",
                    "endDate": "April 2009",
                    "isCurrent": false,
        ...
        it('should create "work history" model with 10 entries fetched from xhr', function() {
            expect(scope.jobs).toBeUndefined();
            $httpBackend.flush();
            expect(scope.jobs.length).toEqual(10);
        });
    });
